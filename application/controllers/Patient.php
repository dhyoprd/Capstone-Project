...
class Patient extends CI_Controller { 
  ...
  function antrian (){
        $page_data['page_name'] =   'antrian';
        $page_data['page_title'] =   get_phrase('Queue');
        $this->load->view('backend/index', $page_data);
    }
    
    function edit_queue ($appointment_id){
        ...
        $page_data['page_name'] =   'edit_queue';
        $page_data['page_title'] =   get_phrase('Edit Queue');
        $this->load->view('backend/index', $page_data);
    }
   ...
   function add_appointment ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            $this->appointment_model->insertPatientAppointmentTable();
            $this->session->set_flashdata('flash_message', get_phrase('Data Saved Successfully'));
            redirect(base_url() . 'patient/antrian', 'refresh');
        }

        if($param1 == 'update'){

            $this->appointment_model->updatePatientAppointmentInformation($param2);
            $this->session->set_flashdata('flash_message', get_phrase('Data Updated Successfully'));
            redirect(base_url() . 'patient/antrian', 'refresh');
        }
