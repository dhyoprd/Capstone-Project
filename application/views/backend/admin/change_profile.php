                        ...
                        <?php echo form_open(base_url() . 'admin/change_profile/update_info/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                <label class="col-md-12" for="example-text"><?php echo get_phrase('full_name');?>*</span>
                                    <div class="col-md-12">
                                        <input type="text" name="name" value="<?php echo $admin['name'];?>" class="form-control form-control-line" required>
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-12" for="example-text"><?php echo get_phrase('email');?>*</span>
                                    <div class="col-md-12">
                                        <input type="email" name="email" value="<?php echo $admin['email'];?>"  class="form-control form-control-line" id="example-email" required>
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-12" for="example-text"><?php echo get_phrase('phone_number');?>*</span>
                                    <div class="col-md-12">
                                        <input type="text" name="phone" value="<?php echo $admin['phone'];?>" class="form-control form-control-line" required>
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-12" for="example-text"><?php echo get_phrase('address');?>*</span>
                                    <div class="col-md-12">
                                        <textarea class="form-control" name="address" required><?php echo $admin['address'];?></textarea>
                                    </div>
                            </div>
