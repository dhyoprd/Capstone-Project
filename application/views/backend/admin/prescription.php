        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <?php if (isset($appointment)): ?>
                    <?php
                    echo form_open(base_url() . 'prescription/add_prescription/prescription/' . $appointment['appointment_id'], [
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" name="appointment_id" value="<?php echo $appointment['appointment_id']; ?>" class="form-control" readonly>
                        </div>
                    </div>
            ...
            toothElement.style.backgroundColor = 'red';
                    ...
                    <div id="doc_entries">
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input name="entry_medicine_type[]" type="text" class="form-control"
                                    placeholder="<?php echo get_phrase('medicine_type'); ?>">
                            </div>
                    ...
                    <!-- <input type="text" name="odontogram_entries" id="temporary_odontogram_entries"
                        style="display: none;">
