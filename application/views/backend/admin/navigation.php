        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li> 
                        <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-calendar-o p-r-10"></i> <span class="hide-menu"> <?php echo get_phrase('Manage Schedule');?> <span class="fa arrow"></span></span></a>
                    ...
                    <li> 
                        ...
                        <ul class="nav nav-second-level"<?php if($page_name == 'add_appointment' || $page_name == 'list_appointment'|| $page_name == 'antrian') echo 'active';?>>
                    ...
                    <li> 
                        <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-medkit p-r-10"></i> <span class="hide-menu"> <?php echo get_phrase('Manage Medicine');?> <span class="fa arrow"></span></span></a>
...
-->
                    ...
                    <a href="<?php echo base_url();?>payment/list_invoice" class="waves-effect">
                        <i class="fa fa-list-alt p-r-10"></i>
                        <span class="hide-menu"><?php echo get_phrase('List Invoice');?></span></a> 
                    </li>
                    ...
                    <li> 
                        ...
                        <ul class="nav nav-second-level"<?php if($page_name == 'general_settings' || $page_name == 'backup_database') echo 'active';?>>
