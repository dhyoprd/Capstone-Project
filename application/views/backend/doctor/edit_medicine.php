		...
		<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Edit Medicine'); ?></div>
                ...
                foreach ($select_medicine as $key => $value) {  ?>
                    <?php echo form_open(base_url(). 'doctor/manage_medicine/update/'. $param2, array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
